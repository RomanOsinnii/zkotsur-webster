    ...
    return (
        <main className="app-shell">
            <section className="panel">
                ...
                <h1>Graphic design platform starter 21</h1>
                <p className="lead">Frontend container is connected to the Nest API. Use this as the base for the product surface and internal tools.</p>
